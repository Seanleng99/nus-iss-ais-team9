...
| MLSecOps/LLMSecOps CI/CD | Implemented | GitHub Actions CI/release, CodeQL, dependency review, ECR/Inspector gates, immutable tags, rollback, protected demo environment, and AWS OIDC roles | Retain workflow and deployment evidence for the final assessment and review protection settings periodically. |
